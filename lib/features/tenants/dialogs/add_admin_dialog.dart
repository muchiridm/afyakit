...
class AddAdminPayload {
  AddAdminPayload({
    required this.email,
    required this.role, // 'admin' | 'manager'
...
class AddAdminDialog extends StatefulWidget {
  ...
  final String tenantSlug; // purely for display if you want; no logic here
...
class _AddAdminDialogState extends State<AddAdminDialog> {
  ...
  void _submit() {
    ...
    setState(() => _busy = true);
    // Dumb dialog: just return the payload; controller will do the network call.
    Navigator.pop(
      context,
