// lib/features/retail/sales/shared/widgets/sales_doc_dialogs.dart
...
class SalesDocDialogs {
  ...
  // ───────────────────────────────
  // One dialog: edit line (item + qty + rate)
  // ───────────────────────────────
...
class _LineEditDialogState extends State<_LineEditDialog> {
  ...
  void _submit() {
    ...
    Navigator.pop(
      context,
      SalesDocLineEditResult(name: name, qty: qty, rate: rate),
    );
  }
