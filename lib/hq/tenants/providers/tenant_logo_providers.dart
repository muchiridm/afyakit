...
final tenantPrimaryLogoUrlProvider = Provider<String?>((ref) {
...
final tenantSecondaryLogoUrlProvider = Provider<String?>((ref) {
  final cfg = ref.watch(tenantProfileProvider);
  final path = 'public/${cfg.id}/branding/logos/logo-secondary.png';
  return _gcsUrl(path);
});
