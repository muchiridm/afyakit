// lib/hq/tenants/v2/services/tenant_profile_service.dart
import 'dart:async';
import 'dart:convert';
...
/// DI: v2 TenantProfileService
final tenantProfileServiceProvider =
    FutureProvider.autoDispose<TenantProfileService>((ref) async {
      ...
      return TenantProfileService(dio: client.dio, routes: routes);
    });

class TenantProfileService {
  TenantProfileService({required this.dio, required this.routes});
