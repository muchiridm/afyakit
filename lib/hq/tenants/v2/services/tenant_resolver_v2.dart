// lib/hq/tenants/v2/services/tenant_resolver_v2.dart

import 'package:flutter/foundation.dart' show kIsWeb;
import 'package:cloud_firestore/cloud_firestore.dart';

/// Fast, sync resolver (query → simple hostname hints → default).
String resolveTenantSlugV2({String defaultSlug = 'afyakit'}) {
...
Future<String> resolveTenantSlugAsyncV2({
  ...
  if (localHosts.contains(host)) {
    return resolveTenantSlugV2(defaultSlug: defaultSlug);
  }
