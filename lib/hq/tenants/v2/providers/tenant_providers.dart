// lib/hq/tenants/v2/providers/tenant_providers.dart
...
// users (admins list still hits /users, that’s fine)
import 'package:afyakit/hq/users/all_users/all_user_model.dart';
import 'package:afyakit/hq/tenants/v1/dtos/team_member_dto.dart'; // just for the DTO shape
