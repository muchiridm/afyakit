// lib/hq/screens/hq_login_screen.dart
import 'package:afyakit/hq/controllers/hq_login_controller.dart';
...
class _HqLoginScreenState extends ConsumerState<HqLoginScreen> {
  ...
  Future<void> _submit() async {
    ...
    // HqGate will react to idTokenChanges(); no navigation here.
  }

  Future<void> _resetPassword() async {
    // controller handles validation/toasts; we just pass whatever is typed
    await ref
        .read(hqLoginControllerProvider.notifier)
  ...
  Widget _buildHeader(BuildContext context) {
    return Column(
      children: [
        ...
        const SizedBox(height: 12),
        Text('AfyaKit HQ', style: Theme.of(context).textTheme.headlineSmall),
      ],
    );
  }
